...
class BERTEmbedding(nn.Module):
    """
    BERT Embedding which is consisted with the following features:
        1. TokenEmbedding : normal embedding matrix
        2. PositionalEmbedding : adding positional information using sin, cos

        The sum of all these features is the output of BERTEmbedding.
    """
...
class BERT(nn.Module):
    def __init__(self, max_seq_length, vocab_size, bert_num_blocks, bert_num_heads,
                 hidden_size, bert_dropout):
        super().__init__()
        ...
        # BERT embedding: token + positional
